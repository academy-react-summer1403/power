...
export const RequestCard = ({ image, title, description }) => (
  <div className="w-[700px] h-[260px] bg-white dark:bg-gray-900 rounded-2xl flex justify-center sm:justify-normal items-center overflow-hidden" data-aos="zoom-in">
